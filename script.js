document.addEventListener('DOMContentLoaded', () => {
  ...
  if (overlapEnquiryForm) {
    overlapEnquiryForm.addEventListener('submit', (e) => {
      ...
      const selectedProp = property === 'melange' ? 'Mantra Melange' : (property === 'magnus' ? 'Mantra Magnus' : (property === 'mayfair' ? 'Mayfair' : (property === 'marvilla' ? 'Mantra Marvilla' : 'Mantra Properties')));
